...
const OtherInfo = ({navigation, route}) => {
  ...
  const getStates = async() => {
    try {
      ...
      const res = await axios.get(`${apiBaseURL}/common/states.php`);
  ...
  const getLGAs = async(state_id) => {
    try {
      ...
      const res = await axios.get(`${apiBaseURL}/common/lgas.php?state_id=${state_id}`);
  ...
  const updateRecord = async(data) => {
     ...
     LogBox.ignoreAllLogs();
      ...
      try {
        setPending(true);
        console.log("Here")
        const res = await axios.post(`${apiBaseURL}/kaadi_client/update_birthplace.php`,  Data);
